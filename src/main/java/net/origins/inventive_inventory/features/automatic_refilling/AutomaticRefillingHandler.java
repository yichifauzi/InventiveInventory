...
public class AutomaticRefillingHandler {
    ...
    public static final List<Class<? extends Item>> TOOL_CLASSES = List.of(SwordItem.class, PickaxeItem.class, AxeItem.class, ShovelItem.class, HoeItem.class, BowItem.class, CrossbowItem.class, TridentItem.class);
    ...
    private static List<Integer> getSameItemSlots(ItemStack handStack) {
        ...
        Stream<Integer> sameItemSlotsStream = slotRange.stream()
                .filter(slot -> {
                    ...
                    boolean isEqualAndNoTool = ItemStack.areItemsEqual(handStack, itemStack) && NbtHelper.matches(handStack.getNbt(), itemStack.getNbt(), true) && !TOOL_CLASSES.contains(itemStack.getItem().getClass());
